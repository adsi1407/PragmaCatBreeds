...
// Usage: dart run scripts/ci/validation/check_widgets_coverage.dart <path-to-lcov.info> <min-percentage>
import 'dart:io';

void main(List<String> args) async {
  if (args.length < 2) {
    stderr.writeln('Usage: dart run scripts/ci/validation/check_widgets_coverage.dart <lcov.info> <minPercent>');
    exit(2);
  }
