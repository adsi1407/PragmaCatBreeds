...
void main() {
  group('CatBreedApi', () {
    ...
    group('getCatBreeds |', () {
      test(
        'apiReturnsValidData | successfulResponse | returnsListOfCatBreedDto',
        () async {
          // Arrange
      ...
      test(
        'apiReturnsEmptyList | responseDataEmpty | returnsEmptyList',
        () async {
          // Arrange
          final mockResponse = Response<List<dynamic>>(
      ...
      test(
        'dioThrowsConnectionTimeout | connectionTimeout | propagatesDioException',
        () async {
          // Arrange
      ...
      test(
        'dioThrowsServerError | badResponse | propagatesDioException',
        () async {
          // Arrange
          final dioError = DioException(
            requestOptions: RequestOptions(path: '/breeds'),
    ...
    group('searchCatBreeds |', () {
      test(
        'apiReturnsFilteredData | validSearchQuery | returnsFilteredList',
        () async {
          // Arrange
      ...
      test(
        'apiReturnsNoMatches | noMatchingBreeds | returnsEmptyList',
        () async {
          // Arrange
      ...
      test(
        'searchCatBreeds | specialCharacters | handlesQueryCorrectly',
        () async {
          // Arrange
      ...
      test(
        'searchCatBreeds | receiveTimeout | propagatesDioException',
        () async {
          // Arrange
          const searchQuery = 'persian';
          final dioError = DioException(
    ...
    group('getCatBreedById', () {
      test('getCatBreedById | validBreedId | returnsCatBreedDto', () async {
        ...
        when(
          () => mockDio.get<Map<String, dynamic>>('/breeds/$breedId'),
        ).thenAnswer((_) async => mockResponse);
      ...
      test(
        'getCatBreeds | connectionTimeout | propagatesDioException',
        () async {
          // Arrange
          const breedId = 'abys';
          final dioError = DioException(
      ...
      test(
        'getCatBreedById | notFoundResponse | handles404Correctly',
        () async {
          // Arrange
      ...
      test(
        'getCatBreedById | specialCharactersInId | handlesSpecialCharacters',
        () async {
          // Arrange
    ...
    group('real world scenarios', () {
      test(
        'getCatBreedById | malformedJsonResponse | handlesMalformedJsonGracefully',
        () async {
          // Arrange
          final mockResponseData = [
            {
      ...
      test('getCatBreeds | largeResponseData | handlesLargeDataSets', () async {
        // Arrange
        final largeResponseData = List.generate(
          100,
          (index) => {
            'id': 'breed_$index',
            'name': 'Breed $index',
      ...
      test(
        'getCatBreeds | concurrentRequests | handlesConcurrentRequests',
        () async {
          // Arrange
          final mockResponseData = [
            {'id': 'concurrent_test', 'name': 'Concurrent Test Cat'},
          ];
      ...
      test(
        'getCatBreeds | networkExceptions | handlesNetworkExceptions',
        () async {
          // Arrange
    ...
    group('integration with translator', () {
      test(
        'getCatBreeds | translatorIntegration | integratesWithTranslatorCorrectly',
        () async {
          // Arrange
          final mockResponseData = [
            {
